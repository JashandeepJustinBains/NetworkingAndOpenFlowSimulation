...
if __name__ == '__main__':
    ...
    print("forward receiving port=", forward_recv_port)
    print("recv address=", receiver_addr)
    print("backward recv port=", backward_recv_port)
    
    print("sender address=", sender_addr)
    print("sender recv port=", sender_recv_port)
