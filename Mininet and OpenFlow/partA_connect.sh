...
$ofctl add-flow s1 \
    in_port=3,ip,nw_src=10.0.4.2,nw_dst=10.0.1.2,actions=mod_dl_src:0A:00:00:01:00:01,mod_dl_dst:0A:00:01:02:00:00,output=1 
# s2
$ofctl add-flow s2 \
...
# s0
$ofctl add-flow s0 \
    in_port=1,ip,nw_src=10.0.0.2,nw_dst=10.0.2.2,actions=mod_dl_src:0A:00:00:01:00:01,mod_dl_dst:0A:00:0B:FE:00:02,output=3
$ofctl add-flow s0 \
    in_port=3,ip,nw_src=10.0.2.2,nw_dst=10.0.0.2,actions=mod_dl_src:0A:00:00:01:00:01,mod_dl_dst:0A:00:00:02:00:00,output=1 
# s2
$ofctl add-flow s2 \
    in_port=2,ip,nw_src=10.0.0.2,nw_dst=10.0.2.2,actions=mod_dl_src:0A:00:0B:FE:00:02,mod_dl_dst:0A:00:02:02:00:00,output=1 
$ofctl add-flow s2 \
    in_port=1,ip,nw_src=10.0.2.2,nw_dst=10.0.0.2,actions=mod_dl_src:0A:00:02:01:00:01,mod_dl_dst:0A:00:0B:01:00:03,output=2
